...
var SrvSpec = function (_RosMsgSpec2) {
  ...
  function SrvSpec(msgCache, packageName, messageName, type) {
    ...
    var _this5 = _possibleConstructorReturn(this, (SrvSpec.__proto__ || Object.getPrototypeOf(SrvSpec)).call(this, msgCache, packageName, messageName, type, filePath));

    _this5._loadMessageFile(filePath);

    _this5.request = new MsgSpec(msgCache, packageName, messageName + 'Request', SRV_REQUEST_TYPE, null, _this5.fileContents);
    _this5.response = new MsgSpec(msgCache, packageName, messageName + 'Response', SRV_RESPONSE_TYPE, null, _this5.fileContents);
    return _this5;
  }
...
var ActionSpec = function (_RosMsgSpec3) {
  ...
  function ActionSpec(msgCache, packageName, messageName, type) {
    ...
    var _this6 = _possibleConstructorReturn(this, (ActionSpec.__proto__ || Object.getPrototypeOf(ActionSpec)).call(this, msgCache, packageName, messageName, type, filePath));

    _this6._loadMessageFile(filePath);

    // Parse the action definition into its 3 respective parts
    _this6.goal = new MsgSpec(msgCache, packageName, messageName + 'Goal', ACTION_GOAL_TYPE, null, _this6.fileContents);
    _this6.result = new MsgSpec(msgCache, packageName, messageName + 'Result', ACTION_RESULT_TYPE, null, _this6.fileContents);
    _this6.feedback = new MsgSpec(msgCache, packageName, messageName + 'Feedback', ACTION_FEEDBACK_TYPE, null, _this6.fileContents);
    _this6.generateActionMessages();
    return _this6;
  }
