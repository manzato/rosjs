  ...
  _createClass(MessageManager, [{
    ...
    value: function buildPackageTree(outputDirectory) {
      ...
      return this.initTree().then(function () {
        ...
        return _this._packageChain.reduce(function (prev, cur, index, pkgs) {
          var pkgName = pkgs[index];
          // don't need to load deps for each package since all packages are being loaded
          return prev.then(_this.loadPackage.bind(_this, pkgName, outputDirectory, false));
        }, Promise.resolve());
      }).then(function () {
    ...
    value: function buildPackage(packageName, outputDirectory) {
      ...
      var deps = new Set();
      return this.initTree().then(function () {
        _this2.loadPackage(packageName, outputDirectory, true, function (depName) {
          if (!deps.has(depName)) {
            deps.add(depName);
            return true;
          }
    ...
    value: function loadPackage(packageName, outputDirectory) {
      ...
      var filterDepFunc = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      ...
      return this.initPackageLoad(packageName, outputDirectory).then(this.loadPackageMessages.bind(this, packageName, outputDirectory)).then(this.loadPackageServices.bind(this, packageName, outputDirectory)).then(function () {
    ...
    key: 'initPackageLoad',
    value: function initPackageLoad(packageName, jsMsgDir) {
      var _this5 = this;
    ...
    key: 'loadPackageMessages',
    value: function loadPackageMessages(packageName, jsMsgDir) {
      var _this6 = this;
    ...
    key: 'loadPackageServices',
    value: function loadPackageServices(packageName, jsMsgDir) {
      var _this7 = this;
