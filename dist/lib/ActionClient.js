...
var ActionClient = function (_EventEmitter) {
  ...
  function ActionClient(options) {
    ...
    _this._goalPub = nh.advertise(_this._actionServer + '/goal', _this._actionType + 'Goal', { queueSize: 1, latching: true });

    _this._cancelPub = nh.advertise(_this._actionServer + '/cancel', 'actionlib_msgs/GoalID', { queueSize: 1, latching: true });
